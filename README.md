This is a modified version of the port done by PseudoResonance for the Pixy to run on a FIRST Robotics RoboRio in Java.  Their project has not been updated since 2020.  Since then, several of their links have become broken and WPILib has removed several of the SPI methods used in their code breaking it as well.  I am attempting to update it to 2024 libraries, but it is still in the testing phase.  I will update this when i confirm it is working.  

I have left the original Readme file below as a reference.
